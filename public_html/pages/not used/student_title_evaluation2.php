<?php
              ...
              if($result){
                  ...
                  echo'
                      <script>
                            ...
                            document.getElementById("backgroundID").value = ' . json_encode($background) . ';
                      </script>
                    ';
              }
  ...
  function saveBackground(){
      ...
      try{
          ...
          $sql = "UPDATE title_proposal SET background = ? WHERE projectID = ? AND titleNum = ?";
          $stmt = $conn->prepare($sql);
          $result = $stmt->execute([$_SESSION["background"], $_SESSION["projectID"], $_SESSION["titleNum"]]);
          ...
          if($result){
              ...
              echo '<script>
                    Swal.fire({
                         title: "Success",
                        text: "Background of the Study Succesfuly Saved!",
                        icon: "success",
                        confirmButtonText: "OK"
                    }).then((result) => {
                        if (result.isConfirmed) {
                            window.location.href = "/edit_title_evaluation_background";
                        }
                    });
                  </script>';
          }
        ...
        unset($_POST["save-button"]);
            ...
            echo '<script>
                Swal.fire({
                     title: "Error Saving Background of the Study",
    ...
    <body>
        ...
        <?php include 'menu.php'; ?>
            ...
            <form method="POST" action="">
                ...
                <div class="team-info">
                    <textarea id="backgroundID" name="background" rows="8" style="height: 300px; font-size: 17px; font-weight: bold;" placeholder="Background of the Study Paragraph..."></textarea>
                </div>
                
                <br>
                
                <div>
                    <button class="save-button" name="save-button" type="Submit">Save Background of Study</button>
                </div>
            ...
            <div class="pagination">
                 ...
                 <a href="/edit_title_evaluation_importance">3</a>
