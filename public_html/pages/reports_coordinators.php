<?php
   ...
   function generateReport() {
        ...
        try {
            ...
            header('Content-Disposition: attachment; filename="Coordinators_Report_' . date('F_d_Y') . '.xlsx"');
            ...
            foreach ($users as $user) {
                ...
                $sql = "SELECT * FROM sections WHERE coordinatorID = ? AND academicYearID = ?";
                $stmt = $conn->prepare($sql);
...
<html lang="en">
    <head>
        ...
        <title>Coordinators Reports</title>
    ...
    <body>
        ...
        <div id="content2">
            <div class="profile-tabs">
                <div class="tabs">
                    <button class="active" onclick="window.location.href='/reports_coordinators';">Coordinators</button>
       ...
       <!--<h2>Accounts</h2>
        ...
        <div class="accounts-body">
            <div class="left-section">
                ...
                <div class="coordinator-access-group">
                    <div class="coordinator-section">
                        <label for="coordinator">Coordinator</label>
                        <div id="coordinator" class="coordinator-box">
                ...
                <label for="coordinatorSearch">Search a Coordinator using 
                ...
                <input type="text" id="coordinatorSearch" placeholder="Enter Name or Email" onkeyup="filterCoordinators()" style="font-size: 20px; width: 100%;">
                
                <br><br>
                
                <select class="custom-dropdown" name="coordinatorBox" id="coordinatorResults" size="10"  style="height: 300px;" required>
                    <?php getCoordinatorValues(); ?>
                </select>
            </div>
            <div class="right-section">
                
                <p class="divider-label">Coordinated Sections</p>
        ...
        <div class="accounts-footer">
            <form action="" method="POST">
                <button type="submit" name="report-btn" class="btn-update">Generate Coordinators Report</button>
            </form>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#coordinatorResults').click(function() { //Change or Click depends on situation
        ...
        function filterCoordinators() {
            ...
            const select = document.getElementById('coordinatorResults');
