...
<div id="content">
    ...
    <button type="button" onclick="backFeature()" style="display: flex; align-items: center; background-color: #6A6873; color: white; margin-bottom: 50px; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
        <span style="font-size: 18px; margin-right: 8px;">&#8592;</span> <!-- Left arrow -->
        Back
    </button>
