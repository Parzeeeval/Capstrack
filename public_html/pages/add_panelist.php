...
<?php 
    ...
    function addPanelist(){
        ...
        try{
                ...
                if($countResult){
                    ...
                    if(($current_count + 1) <= $current_limit){
                        ...
                        if($result){
                            ...
                            $stmt = $conn->prepare($sql);
                            $result = $stmt->execute([$panelistID, $projectID, 1, $acadYear]);
                            ...
                            if($result){
                                ...
                                $desc = $coord_name . " added you as a CAPSTONE PANELIST for a capstone group in " . $section;
                                ...
                                if($result){
                                     ...
                                     $action = "". $surname . ", " . $firstname . " " . $middlename . " added " . $panelist_name . " as a panelist of Group " . $groupNum . " in " . $section;
                                    ...
                                    unset($_POST["add-button"]);
                                     ...
                                     echo '<script>
                                        Swal.fire({
                                            title: "Success",
                                            text: "Capstone Panelist successfully added!",
                                            icon: "success",
                                            confirmButtonText: "OK"
                                        }).then((result) => {
                                            if (result.isConfirmed) {
                                                window.location.href = "/add_panelist";
                                            }
                                ...
                                throw new Exception("Error inserting new panelist");
                            }
                        }
                    }
            ...
            echo '<script>
                Swal.fire({
                     title: "Error Adding Panelist",
                    text: "Panelist could not be added: '.addslashes($e->getMessage()).'",
                    icon: "error",
                    confirmButtonText: "OK"
                }).then((result) => {
                    if (result.isConfirmed) {
...
<head>
    ...
    <title>Add Capstone Panelist</title>
            ...
            <div class="optionDiv">
                <div class="right-section">
                    ...
                    <div class="button-group">
                        <button class="form-button" type="submit" name="add-button">Add Panelist</button>
                    </div>
                </div>
            </div> 
        </form>
