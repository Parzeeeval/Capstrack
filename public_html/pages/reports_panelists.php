<?php
   ...
   function generateReport() {
        ...
        try {
            ...
            header('Content-Disposition: attachment; filename="Panelists_Report_' . date('F_d_Y') . '.xlsx"');
            ...
            foreach ($users as $user) {
                ...
                $sql = "SELECT projectID FROM panelists WHERE panelistID = ? AND academicYearID = ?";
                $stmt = $conn->prepare($sql);
...
<html lang="en">
        ...
        <div id="content2">
            <div class="profile-tabs">
                <div class="tabs">
                    ...
                    <button class="active" onclick="window.location.href='/reports_panelists';">Panelists</button>
       ...
       <!--<h2>Accounts</h2>
            ...
            <div class="left-section">
                ...
                <div class="panelist-access-group">
                    <div class="panelist-section">
                        ...
                        <div id="panelist" class="panelist-box">
                ...
                <label for="panelistSearch">Search a Panelist using 
                ...
                <input type="text" id="panelistSearch" placeholder="Enter Name or Email" onkeyup="filterPanelists()" style="font-size: 20px; width: 100%;">
                
                <br><br>
                
                <select class="custom-dropdown" name="panelistBox" id="panelistResults" size="10"  style="height: 300px;" required>
                    <?php getPanelistValues(); ?>
                </select>
            </div>
            <div class="right-section">
                
                <p class="divider-label">Paneled Capstone Groups</p>
        ...
        <div class="accounts-footer">
            <form action="" method="POST">
                <button type="submit" name="report-btn" class="btn-update">Generate Panelists Report</button>
            </form>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#panelistResults').click(function() { //Change or Click depends on situation
        ...
        function filterPanelists() {
            const input = document.getElementById('panelistSearch');
            const filter = input.value.toLowerCase();
            const select = document.getElementById('panelistResults');
